<?php include ('includes/secondaryHeader.php'); ?>


<body>
	<div id=header>
		<!--<img src="images/spoonFedlogo.png" alt="Logo" width="30%"/><a href="template.html"></a>-->
...
<?php include ('includes/nav.php'); ?>
	...
	<div id="banner"><img src="RFimages/diningTable.jpg" alt="dining"/>
    </div>
...
<div id="content">
    ...
    <div id="article">
        <h2><a href="history.php" alt="history">History</a></h2>
...
<!--<div id="aside">
    	<ul>
            ...
            <li> <a href="farmtotable.php">Farm to Table</a></li>
